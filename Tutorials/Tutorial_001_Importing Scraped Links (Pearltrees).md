...
**Note 1** the "Desktop_Cmd.bat" approach is recommended for more advanced users and will be discussed in another tutorial. This bat file facilitates easier command-line access (see Note 3 below).
...
![Tutorial_001_wikicats_0425.png](./001/Tutorial_001_wikicats_0425.png)
...
![Tutorial_001_shortcut_loc_0810.png](./001/Tutorial_001_shortcut_loc_0810.png)
...
Currently, the export location is hardcoded based on the current user. Future versions will allow this path to be customized. In this example the Bookmarks file is exported to 2024-08-11_11-11-30.html, as shown below:
![Tutorial_001_export_loc_1931.png](./001/Tutorial_001_export_loc_1931.png)
...
![Tutorial_001_add_button_2729.png](./001/Tutorial_001_add_button_2729.png)

\
3.**c**. **Select the import tab:**

\
![Tutorial_001_import_tab_2839.png|300](./001/Tutorial_001_import_tab_2839.png)

\
3.**d**. **Select, "My Bookmarks":**

\
![Tutorial_001_MyBookmarks_button_3612.png|300](./001/Tutorial_001_MyBookmarks_button_3612.png)

\
3.**e**. Click on the square that says, "chrome".

\
![Tutorial_001_Chrome_Button_3821.png|300](./001.Tutorial_001_Chrome_Button_3821.png)

\
3.**f**. Select upload.

\
![Tutorial_001_BookmarkUpload_Button_4021.png](./001/Tutorial_001_BookmarkUpload_Button_4021.png)
...
![Tutorial_001_AddBookmarks_button_20846.png](./001/Tutorial_001_AddBookmarks_button_20846.png)
...
![Tutorial_001_Navigate_into_BookmarkFolder_23004.png](./001/Tutorial_001_Navigate_into_BookmarkFolder_23004.png)
...
![Tutorial_001_add_bookmarks_button_32151.png](./001/Tutorial_001_add_bookmarks_button_32151.png)
  
3.**m**. Move the imported folder to the desired location on the Pearltrees page:
![Tutorial_001_Place_Inported_borkmarks_33254.png](./001/Tutorial_001_Place_Inported_borkmarks_33254.png)
...
![Tutorial_001_edit_button_33831.png](./001/Tutorial_001_edit_button_33831.png)
